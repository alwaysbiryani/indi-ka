...
const OnlineStatusToasts = dynamic(() => import('@/components/home/OnlineStatusToasts'), { ssr: false });
  ...
  return (
    <main className="min-h-dvh w-full bg-[var(--app-bg)] flex items-center justify-center p-0 lg:p-8 font-sans overflow-hidden relative transition-colors duration-200">
      ...
      <div className="relative z-10 w-full flex flex-col items-center">
        ...
        <OnlineStatusToasts isOnline={isOnline} justReconnected={justReconnected} />
